class GoogleOauthService
  def google_oauth2_url
    ...
    # redirect_uri = CGI.escape('https://pom-planner-be-31825074f3c8.herokuapp.com/api/v1/auth/google_oauth2/callback')
    redirect_uri = CGI.escape('http://localhost:3000/api/v1/auth/google_oauth2/callback')
